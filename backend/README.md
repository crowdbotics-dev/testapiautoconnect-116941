...
## Project Structure
    ...
    ├── testapiautoconnect_116941  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116941`
...
2. Clone this repo and `cd testapiautoconnect_116941`
